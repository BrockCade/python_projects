...
led.value = True
rw = digitalio.DigitalInOut(board.GP12)
rs = digitalio.DigitalInOut(board.GP0)
we = digitalio.DigitalInOut(board.GP1)
a0 = digitalio.DigitalInOut(board.GP9)
a1 = digitalio.DigitalInOut(board.GP8)
a2 = digitalio.DigitalInOut(board.GP7)
a3 = digitalio.DigitalInOut(board.GP6)
a4 = digitalio.DigitalInOut(board.GP5)
a5 = digitalio.DigitalInOut(board.GP4)
a6 = digitalio.DigitalInOut(board.GP3)
a7 = digitalio.DigitalInOut(board.GP2)
